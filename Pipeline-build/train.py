...
def parse_args():
    ...
    ap.add_argument("--train_dataset", type=str, default="gsm8k_train",
                    help="Training dataset name (default: gsm8k_train). "
                         "Other options: math_train, math_hard.")
    ap.add_argument("--val_dataset",   type=str, default="gsm8k_val",
                    help="Validation dataset name (default: gsm8k_val). "
                         "Other options: math_val, math500.")
...
def main():
    ...
    train_prompts = [json.loads(l)["prompt"]
                     for l in open(dataset_path(args.train_dataset), encoding="utf-8")]
    val_prompts   = [json.loads(l)["prompt"]
                     for l in open(dataset_path(args.val_dataset),   encoding="utf-8")]
