...
OUT_CSV="${OUT_CSV:-${REPO}/results/passK/passk_baselines.csv}"
MARKER_DIR="${REPO}/results/passK/.passk_baseline_done"
LOG_DIR="${REPO}/results/passK/logs_passk_baselines"
