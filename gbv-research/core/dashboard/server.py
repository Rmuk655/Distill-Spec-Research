"""
viz_server.py — Web dashboard for SpecDist experiment results.

Start:
    python viz_server.py           # http://localhost:5000
...
_SERVER_HERE = os.path.dirname(os.path.abspath(__file__))   # core/dashboard/
_GBV_RESEARCH = os.path.dirname(os.path.dirname(_SERVER_HERE))  # gbv-research/
# Add gbv-research/db/ so `import results_db` resolves correctly
sys.path.insert(0, os.path.join(_GBV_RESEARCH, "db"))
import results_db

HERE          = _SERVER_HERE
_BE_LOG       = os.path.join(_GBV_RESEARCH, "orchestration", "be_progress.log")
_PIPELINE_LOG = os.path.join(_GBV_RESEARCH, "orchestration", "pipeline_output.log")
