...
def api_pipeline_status():
    ...
    # Phase labels — match ACTUAL execution order (parallel groups):
    #
    #   Ph 1 — Baseline          group 0  (1 step)
    #   Ph 2 — All Training      group 1  (all train + merge steps, flat AND tree)
    #                            NOTE: the scheduler runs these one GPU-slot at a time,
    #                            so flat and tree losses interleave.  Eval CANNOT start
    #                            until every train+merge in this phase is done.
    #   Ph 3 — GSM8K Eval        group 3  (all flat + tree GSM8K evals)
    #   Ph 4 — Multi-DS Eval     group 3  (multi-dataset evals, T4/A100 only)
    #   Ph 5 — EAGLE             separate (EAGLE-specific steps)
    #
    PHASE_LABELS = {
        "eval_baseline_gsm8k":           "Ph 1 — Baseline",
        # ── Flat losses: train + merge (all in scheduler group 1) ─────────────
        "train_kl_gsm8k":                "Ph 2 — All Training",
        "merge_kl_gsm8k":                "Ph 2 — All Training",
        "train_ebe_gsm8k":               "Ph 2 — All Training",
        "merge_ebe_gsm8k":               "Ph 2 — All Training",
        "train_ebe_single_gsm8k":        "Ph 2 — All Training",
        "merge_ebe_single_gsm8k":        "Ph 2 — All Training",
        "train_rev_kl_gsm8k":            "Ph 2 — All Training",
        "merge_rev_kl_gsm8k":            "Ph 2 — All Training",
        "train_jsd_gsm8k":               "Ph 2 — All Training",
        "merge_jsd_gsm8k":               "Ph 2 — All Training",
        "train_l1_gsm8k":                "Ph 2 — All Training",
        "merge_l1_gsm8k":                "Ph 2 — All Training",
        "online_adapt_gsm8k":            "Ph 2 — All Training",
        "merge_online_gsm8k":            "Ph 2 — All Training",
        "online_ebe_adapt_gsm8k":        "Ph 2 — All Training",
        "merge_online_ebe_gsm8k":        "Ph 2 — All Training",
        "online_ebe_single_adapt_gsm8k": "Ph 2 — All Training",
        "merge_online_ebe_single_gsm8k": "Ph 2 — All Training",
        # ── Tree losses: train + merge (also group 1 — interleaved with flat) ──
        "train_kl_tree_gsm8k":           "Ph 2 — All Training",
        "merge_kl_tree_gsm8k":           "Ph 2 — All Training",
        "train_bv_tree_gsm8k":           "Ph 2 — All Training",
        "merge_bv_tree_gsm8k":           "Ph 2 — All Training",
        "train_gbv_tree_gsm8k":          "Ph 2 — All Training",
        "merge_gbv_tree_gsm8k":          "Ph 2 — All Training",
        "train_trav_tree_gsm8k":         "Ph 2 — All Training",
        "merge_trav_tree_gsm8k":         "Ph 2 — All Training",
        "train_ebe_tree_gsm8k":          "Ph 2 — All Training",
        "merge_ebe_tree_gsm8k":          "Ph 2 — All Training",
        "train_rev_kl_tree_gsm8k":       "Ph 2 — All Training",
        "merge_rev_kl_tree_gsm8k":       "Ph 2 — All Training",
        "train_jsd_tree_gsm8k":          "Ph 2 — All Training",
        "merge_jsd_tree_gsm8k":          "Ph 2 — All Training",
        "train_naive_tree_gsm8k":        "Ph 2 — All Training",
        "merge_naive_tree_gsm8k":        "Ph 2 — All Training",
        "train_nss_tree_gsm8k":          "Ph 2 — All Training",
        "merge_nss_tree_gsm8k":          "Ph 2 — All Training",
        "train_si_tree_gsm8k":           "Ph 2 — All Training",
        "merge_si_tree_gsm8k":           "Ph 2 — All Training",
        "train_st_tree_gsm8k":           "Ph 2 — All Training",
        "merge_st_tree_gsm8k":           "Ph 2 — All Training",
        "train_khisti_tree_gsm8k":       "Ph 2 — All Training",
        "merge_khisti_tree_gsm8k":       "Ph 2 — All Training",
        "online_kl_tree_adapt_gsm8k":    "Ph 2 — All Training",
        "merge_online_kl_tree_gsm8k":    "Ph 2 — All Training",
        "online_ebe_tree_adapt_gsm8k":   "Ph 2 — All Training",
        "merge_online_ebe_tree_gsm8k":   "Ph 2 — All Training",
        # ── GSM8K Eval — group 3, runs after ALL training done ────────────────
        ...
        "eval_kl_tree_gsm8k":            "Ph 3 — GSM8K Eval",
        "eval_bv_tree_gsm8k":            "Ph 3 — GSM8K Eval",
        "eval_gbv_tree_gsm8k":           "Ph 3 — GSM8K Eval",
        "eval_trav_tree_gsm8k":          "Ph 3 — GSM8K Eval",
        "eval_ebe_tree_gsm8k":           "Ph 3 — GSM8K Eval",
        "eval_rev_kl_tree_gsm8k":        "Ph 3 — GSM8K Eval",
        "eval_jsd_tree_gsm8k":           "Ph 3 — GSM8K Eval",
        "eval_naive_tree_gsm8k":         "Ph 3 — GSM8K Eval",
        "eval_nss_tree_gsm8k":           "Ph 3 — GSM8K Eval",
        "eval_si_tree_gsm8k":            "Ph 3 — GSM8K Eval",
        "eval_st_tree_gsm8k":            "Ph 3 — GSM8K Eval",
        "eval_khisti_tree_gsm8k":        "Ph 3 — GSM8K Eval",
        "eval_online_kl_tree_gsm8k":     "Ph 3 — GSM8K Eval",
        "eval_online_ebe_tree_gsm8k":    "Ph 3 — GSM8K Eval",
        # ── Multi-DS Eval — T4/A100 only ─────────────────────────────────────
        "eval_baseline_all":             "Ph 4 — Multi-DS Eval",
        "eval_kl_all":                   "Ph 4 — Multi-DS Eval",
        "eval_ebe_all":                  "Ph 4 — Multi-DS Eval",
        "eval_ebe_single_all":           "Ph 4 — Multi-DS Eval",
        "eval_rev_kl_all":               "Ph 4 — Multi-DS Eval",
        "eval_jsd_all":                  "Ph 4 — Multi-DS Eval",
        "eval_l1_all":                   "Ph 4 — Multi-DS Eval",
        "eval_online_all":               "Ph 4 — Multi-DS Eval",
        "eval_online_ebe_all":           "Ph 4 — Multi-DS Eval",
        "eval_online_ebe_single_all":    "Ph 4 — Multi-DS Eval",
        "eval_kl_tree_all":              "Ph 4 — Multi-DS Eval",
        "eval_bv_tree_all":              "Ph 4 — Multi-DS Eval",
        "eval_gbv_tree_all":             "Ph 4 — Multi-DS Eval",
        "eval_naive_tree_all":           "Ph 4 — Multi-DS Eval",
        "eval_nss_tree_all":             "Ph 4 — Multi-DS Eval",
        "eval_si_tree_all":              "Ph 4 — Multi-DS Eval",
        "eval_st_tree_all":              "Ph 4 — Multi-DS Eval",
        "eval_khisti_tree_all":          "Ph 4 — Multi-DS Eval",
        "eval_trav_tree_all":            "Ph 4 — Multi-DS Eval",
        "eval_ebe_tree_all":             "Ph 4 — Multi-DS Eval",
        "eval_rev_kl_tree_all":          "Ph 4 — Multi-DS Eval",
        "eval_jsd_tree_all":             "Ph 4 — Multi-DS Eval",
        "eval_online_kl_tree_all":       "Ph 4 — Multi-DS Eval",
        "eval_online_ebe_tree_all":      "Ph 4 — Multi-DS Eval",
        # ── EAGLE ──────────────────────────────────────────────────────────────
